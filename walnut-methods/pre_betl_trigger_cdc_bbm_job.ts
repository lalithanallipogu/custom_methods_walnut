 ...
 */
export async function preBetlTriggerCdcBbmJob(ctx: WalnutApiContext) {
  ...
  ctx.log('CDC BBM job triggered successfully. Status: ' + response.status);
