 ...
 * description: Artifact Use existing ICMEM ID from $[memberId], replace {{key}} placeholders in artifact ${filePath} and upload to /TO_AVER/ via SFTP host ${sftphost} port ${sftpport} user ${sftpusername} password ${sftppassword} and batch in $[batch] with ${forwardDays} days forward
